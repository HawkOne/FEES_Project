...
#ifndef MPU9250_REG_MAP_H
#define MPU9250_REG_MAP_H

/* *****************************************************************************
 * UTILITIES
 *******************************************************************************/

/**Enum that defines the FSRs of the accelerometer */
enum axelFSRchoice 
{
	AFS_2G = 0,       // 2 G 
      	AFS_4G = 8,           // 4 G 
...
/**Enum that defines the FSRs of the gyroscope*/
enum gyroFSRchoice 
{
      	GFS_250DPS = 0,   // 250 deg/s
      	GFS_500DPS = 8,       // 500 deg/s
      	GFS_1000DPS = 16,      // 1000 deg/s
      	GFS_2000DPS = 24      // 2000 deg/s
};
...
#define MPU9250_I2C_7BIT_ADDRESS    0x68 	// Dec 100, I2C bus address of the Axel/gyro sensor 
#define AK8963_I2C_7BIT_ADDRESS     0x0C 	// Dec 12, I2C bus address of the magnetometer

/* *****************************************************************************
 * REGISTER VALUES
 *******************************************************************************/
/*MAGNETOMETER*/
//Sampling mode: always 16 bit for every mode 
#define MPU_AK89XX_OFF_MODE	   0x10  //Disables the sensor and goes in low power mode
#define MPU_AK89XX_SINGLE_MODE	   0x11  //Reads the sensor once
#define MPU_AK89XX_CONT1_MODE	   0x12  //Continuously reads the sensor: mode 1 8hz sample rate
#define MPU_AK89XX_EXT_TR_MODE	   0x14  //Reads the sensor with the external trigger
#define MPU_AK89XX_CONT2_MODE	   0x16  //Continuosly reads the sensor, mode 2: 100hz sample rate
#define MPU_AK89XX_SELF_TEST_MODE  0x18  //Self test enable
#define MPU_AK89XX_ROM_ACC_MODE	   0x1F  //Gives access to the Fuse values in rom

//Bypass for magnetometer
#define MPU_BYPASS_ENABLE		   0x02  //Sets the bypass mode bit, if or-ed with the register (or disables everything but the bypass)
#define MPU_BYPASS_DISABLE		   0xFD  //Clears just the bypass mode bit, if and-ed with the register (or enables everything but the bypass)
