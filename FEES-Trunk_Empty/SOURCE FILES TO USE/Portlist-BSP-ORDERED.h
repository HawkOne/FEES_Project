...
typedef Gpio<GPIOD_BASE,0>      IRIDIUM_SER_DCD;          // SBD DCD- CAN1?
typedef Gpio<GPIOD_BASE,1>      IRIDIUM_SER_DSR;          // SBD DSR- CAN1?
typedef Gpio<GPIOD_BASE,2>      IRIDIUM_SER_DTR;          // SBD DTR?
...
typedef Gpio<GPIOA_BASE,0>      PWM_X_COIL;               //Magnetorquer X
typedef Gpio<GPIOA_BASE,1>      PWM_Y_COIL;               //Magnetorquer Y
typedef Gpio<GPIOA_BASE,2>      PWM_Z_COIL;               //Magnetorquer Z
