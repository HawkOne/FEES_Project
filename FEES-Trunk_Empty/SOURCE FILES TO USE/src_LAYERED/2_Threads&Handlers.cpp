...
void Pin_Mask_All_OFF(){
	...
	HAL_GPIO_WritePin(SBD_ON_OFF_GPIO_Port,SBD_ON_OFF_Pin, 0);
	HAL_GPIO_WritePin(SBD_SER_RI_GPIO_Port,SBD_SER_RI_Pin, 0);
	HAL_GPIO_WritePin(SBD_SER_NET_GPIO_Port,SBD_SER_NET_Pin, 0);
	HAL_GPIO_WritePin(SBD_SER_DCD_GPIO_Port,SBD_SER_DCD_Pin, 0);
	HAL_GPIO_WritePin(SBD_SER_DSR_GPIO_Port,SBD_SER_DSR_Pin, 0);
	HAL_GPIO_WritePin(SBD_SER_DTR_GPIO_Port,SBD_SER_DTR_Pin, 0);
...
#ifdef FREERTOS
	HAL_GPIO_WritePin(ANA_PWR_ON_GPIO_Port,ANA_PWR_ON_Pin, 1);
#endif

#ifdef UNIT_TESTING
	int a= HAL_GPIO_READPin(ANA_PWR_ON_GPIO_Port,ANA_PWR_ON_Pin;

	//Assert( a=1 )
	if(a=1){
		prinf(%s, "ANALOG POWER IS ON ==> ");
		prinf(%i, a ) ;
	}
...
#ifdef FREERTOS
	HAL_GPIO_WritePin(ANA_PWR_ON_GPIO_Port,ANA_PWR_ON_Pin, 0);
#endif
